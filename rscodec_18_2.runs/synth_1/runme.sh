...
HD_PWD='/home/alex/dev/fpga/rscodec/rscodec_18_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gf_poly_mul_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gf_poly_mul_tb.tcl
